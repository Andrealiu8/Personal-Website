...
export const ABOUT_CONTENT = {
  ...
  paragraphs: [
    ...
    'Andrea now works as a freelance musician and performs with the Northwestern Medical Orchestra, while pursuing a career in biotech.',
  ],
  ...
  highlights: [
    ...
    { value: 'Principal Second', detail: 'NU Chamber Orchestra' },
  ],
} as const;
