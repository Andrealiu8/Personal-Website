...
export const ABOUT_CONTENT = {
  ...
  title: 'About Andrea',
  paragraphs: [
    'Violinist Andrea Liu is a graduate of Northwestern University, where she double-majored in Violin Performance and Biological Sciences, studying with Grammy nominated soloist and chamber musician Desiree Ruhstrat at the Bienen School of Music. A dedicated chamber and orchestral musician, Andrea served as Principal Second of the Northwestern University Chamber Orchestra and performed as a soloist with the Bienen School’s Baroque Music Ensemble.',
    'Her training includes summers at the Boston University Tanglewood Institute, where she performed with the Young Artist Orchestra and String Quartet Intensive Program under New England Conservatory professors Peter Zazofsky and Miguel Perez-Espejo Cardenas, as well as studies at the Borromeo Music Festival and the Green Mountain Summer Festival with University of Cininnati Professor Won Bin Yim.',
